...
class PrintBancoDeDadosEventos:
    ...
    def printar_dados_eventos(nome_banco):
        if os.path.exists(nome_banco):
            ...
            # Imprimir dados
            for linha in dados:
                print("ID do Evento: {}, Título: {}, Descrição: {}, Data: {}, Hora do Evento: {}, Local do Evento: {}, Categoria: {}, Organizador: {}, Contato: {}, Inscrição: {}, Custo: {}, Rua: {}, Bairro: {}, Cidade: {}, Estado: {}, CEP: {}, E-mail: {}".format(
                    linha[0], linha[1], linha[2], linha[3], linha[4], linha[5], linha[6], linha[7], linha[8], linha[9], linha[10], linha[11], linha[12], linha[13], linha[14], linha[15], linha[16]))
